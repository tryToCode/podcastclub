<template>
  <div class="py-16 lg:py-24 bg-white">
      <div class="max-w-4xl mx-auto">
        <h2 class="text-2xl font-bold my-2">Welcome to Podcast Club</h2>
        <p>These terms and conditions outline the rules and regulations for the use of 
            Podcast Club's Website.</p> <br /> 
        <span class="uppercase"> Podcast Club</span> is located at:<br /> 
        <address><br />
        </address>

        <p>
        By accessing this website we assume you accept these terms and conditions in full. 
        Do not continue to use Podcast Club's website 
        ...
        whether by formal meetings
        of a fixed duration, or any other means, for the express purpose of meeting the Client's 
        needs in respect
        of provision of the Company's stated services/products, in accordance with 
        ...
        <p>We employ the use of cookies. By using Podcast Club's website you 
        consent to the use of cookies 
        in accordance with Podcast Club's privacy policy.
        </p>
        
        <p>Most of the modern day interactive web sites
        use cookies to enable us to retrieve user details for each visit. 
        Cookies are used in some areas of our site
        to enable the functionality of this area and ease of use for those 
        people visiting. Some of our 
        affiliate / advertising partners may also use cookies.
        </p>
        
        <h2 class="text-xl font-semibold my-2">License</h2>
        <p>Unless otherwise stated, Podcast Club and/or it's licensors own the 
        intellectual property rights for
        all material on Podcast Club. All intellectual property rights are reserved. 
        You may view and/or print
        pages from http://podcastclub.net for your own personal use subject 
        to restrictions set in these terms and conditions.
        </p>

        <p>You must not:</p>
        <ol class="list-disc list-inside my-2">
            <li>Republish material from http://podcastclub.net</li>
            <li>Sell, rent or sub-license material from http://podcastclub.net</li>
            <li>Reproduce, duplicate or copy material from http://podcastclub.net</li>
        </ol>
        <p>Redistribute content from Podcast Club (unless content is specifically 
            made for redistribution).
        </p>
        
        <h2 class="text-xl font-semibold my-2">Hyperlinking to our Content</h2>
        <ol class="list-disc list-inside my-2">
            <li>The following organizations may link to our Web site without prior written approval:
                <ol class="list-disc list-inside my-2">
                    ...
                    <li>Online directory distributors when they list us in the directory 
                        may link to our Web site in the same
        ...
        <ol class="list-disc list-inside my-2">
            <li>These organizations may link to our home page, to publications or to 
                other Web site information so long
            ...
            <li>We may consider and approve in our sole discretion other link 
                ...
                <ol class="list-disc list-inside my-2 pl-4">
        ...
        unfavorably on us or our accredited businesses (for example, trade associations 
        ...
        <p>These organizations may link to our home page, to publications or to other 
            Web site information so long as
        ...
        <p>If you are among the organizations listed in paragraph 2 above and 
            are interested in linking to our website,
        you must notify us by sending an e-mail to 
        <a href="mailto:hello@podcastclub.net" 
        title="send an email to hello@podcastclub.net">
        ...
        address) as well as the URL of your site, a list of any URLs from which 
        you intend to link to our Web site,
        ...
        <ol class="list-disc list-inside my-2">
            ...
            <li>By use of any other description of our Web site or material being linked 
                to that makes sense within the
                context and format of content on the linking party's site.</li>
        </ol>
        <p>No use of Podcast Club's logo or other artwork will be allowed for linking 
            absent a trademark license
        agreement.</p>
        <h2 class="text-xl font-semibold my-2">Iframes</h2>
        <p>Without prior approval and express written permission, you may not create 
            frames around our Web pages or
        use other techniques that alter in any way the visual presentation or 
        appearance of our Web site.</p>
        
        <h2 class="text-xl font-semibold my-2">Reservation of Rights</h2>
        <p>We reserve the right at any time and in its sole discretion to request 
        ...
        at any time. By continuing
        to link to our Web site, you agree to be bound to and abide by these linking 
        terms and conditions.</p>
        
        <h2 class="text-xl font-semibold my-2">Removal of links from our website</h2>
        <p>If you find any link on our Web site or any linked web site objectionable 
        ...
        <h2 class="text-xl font-semibold my-2">Content Liability</h2>
        <p>We shall have no responsibility or liability for any content appearing 
            on your Web site. You agree to indemnify
        ...
        <h2 class="text-xl font-semibold my-2">Disclaimer</h2>
        <p>To the maximum extent permitted by applicable law, we exclude all representations, 
            ...
            and skill). <br /> Nothing in this disclaimer will:
        </p>
        <ol class="list-disc list-inside my-2">
            ...
            <li>limit any of our or your liabilities in any way that is not permitted 
        ...
        <p>To the extent that the website and the information and services 
            on the website are provided free of charge,
        ...
        <p>This Terms and conditions page was created at 
            ...
            termsandconditionstemplate.com</a> generator. If you have
